...
<head>
    ...
    <meta name="description" content="Convert square kilometer (km²) to square mile (mi²) with accurate formulas, examples, and instant calculation."/>
    <meta name="keywords" content="square kilometer to square mile, km² to mi², convert square kilometer to square mile, square kilometer to square mile calculator, how many square miles in a square kilometer, square kilometer in square mile, km² to mi² converter, square kilometer to square mile formula, square kilometer to square mile chart, area conversion square kilometer to square mile, square kilometer to square mile online converter"/>
    <title>square kilometer to square mile Conversion (km² to mi²)</title>
        ...
        <div class="main-wrapper">
            <div class="content-section">
                <div class="converter-section">
                    <h2>square kilometer to square mile Converter</h2>
                    <div class="converter-tool">
                        <div class="input-group">
                            <label for="from-value">square kilometer (km²)</label>
                            <input id="from-value" oninput="performConversion('square-kilometer-km²-to-square-mile-mi²')" placeholder="Enter square kilometer" step="0.01" type="number" value="1"/>
                        </div>
                        <button class="swap-btn" onclick="window.location.href='square-mile-mi²-to-square-kilometer-km².php'" title="Convert square mile to square kilometer">
                    ...
                    <div class="button-group">
                        <button onclick="performConversion('square-kilometer-km²-to-square-mile-mi²')">Calculate</button>
                ...
                <div class="info-section">
                    <div class="about-section">
                        <h3>About square kilometer to square mile Conversion (km² to mi²)</h3>
                        <p>Learn how to accurately convert square kilometer (km²) to square mile (mi²) using verified formulas and conversion charts.</p>
                        <p><strong>Formula:</strong> 1 square kilometer = 0.38610215854245 square mile | Formula: square mile = square kilometer × 0.38610215854245</p>
