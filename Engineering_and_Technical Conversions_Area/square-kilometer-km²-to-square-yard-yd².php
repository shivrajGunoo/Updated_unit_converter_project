...
<head>
    ...
    <meta name="description" content="Convert square kilometer (km²) to square yard (yd²) with accurate formulas, examples, and instant calculation."/>
    <meta name="keywords" content="square kilometer to square yard, km² to yd², convert square kilometer to square yard, square kilometer to square yard calculator, how many square yards in a square kilometer, square kilometer in square yard, km² to yd² converter, square kilometer to square yard formula, square kilometer to square yard chart, area conversion square kilometer to square yard, square kilometer to square yard online converter"/>
    <title>square kilometer to square yard Conversion (km² to yd²)</title>
        ...
        <div class="main-wrapper">
            <div class="content-section">
                <div class="converter-section">
                    <h2>square kilometer to square yard Converter</h2>
                    <div class="converter-tool">
                        <div class="input-group">
                            <label for="from-value">square kilometer (km²)</label>
                            <input id="from-value" oninput="performConversion('square-kilometer-km²-to-square-yard-yd²')" placeholder="Enter square kilometer" step="0.01" type="number" value="1"/>
                        </div>
                        <button class="swap-btn" onclick="window.location.href='square-yard-yd²-to-square-kilometer-km².php'" title="Convert square yard to square kilometer">
                    ...
                    <div class="button-group">
                        <button onclick="performConversion('square-kilometer-km²-to-square-yard-yd²')">Calculate</button>
                ...
                <div class="info-section">
                    <div class="about-section">
                        <h3>About square kilometer to square yard Conversion (km² to yd²)</h3>
                        <p>Learn how to accurately convert square kilometer (km²) to square yard (yd²) using verified formulas and conversion charts.</p>
                        <p><strong>Formula:</strong> 1 square kilometer = 1195990.0463011 square yard | Formula: square yard = square kilometer × 1195990.0463011</p>
