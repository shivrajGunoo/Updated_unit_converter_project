...
<head>
    ...
    <meta name="description" content="Convert square kilometer (km²) to square league () with accurate formulas, examples, and instant calculation."/>
    <meta name="keywords" content="square kilometer to square league, km² to , convert square kilometer to square league, square kilometer to square league calculator, how many square leagues in a square kilometer, square kilometer in square league, km² to  converter, square kilometer to square league formula, square kilometer to square league chart, area conversion square kilometer to square league, square kilometer to square league online converter"/>
    <title>square kilometer to square league Conversion (km² to )</title>
        ...
        <div class="main-wrapper">
            <div class="content-section">
                <div class="converter-section">
                    <h2>square kilometer to square league Converter</h2>
                    <div class="converter-tool">
                        <div class="input-group">
                            <label for="from-value">square kilometer (km²)</label>
                            <input id="from-value" oninput="performConversion('square-kilometer-km²-to-square-league-')" placeholder="Enter square kilometer" step="0.01" type="number" value="1"/>
                        </div>
                        <button class="swap-btn" onclick="window.location.href='square-league--to-square-kilometer-km².php'" title="Convert square league to square kilometer">
                    ...
                    <div class="button-group">
                        <button onclick="performConversion('square-kilometer-km²-to-square-league-')">Calculate</button>
                ...
                <div class="info-section">
                    <div class="about-section">
                        <h3>About square kilometer to square league Conversion (km² to )</h3>
                        <p>Learn how to accurately convert square kilometer (km²) to square league () using verified formulas and conversion charts.</p>
                        <p><strong>Formula:</strong> 1 square kilometer = 3.8610215854245e-08 square league | Formula: square league = square kilometer × 3.8610215854245e-08</p>
