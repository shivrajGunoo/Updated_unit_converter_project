...
<head>
    ...
    <meta name="description" content="Convert square kilometer (km²) to square hectometer (hm²) with accurate formulas, examples, and instant calculation."/>
    <meta name="keywords" content="square kilometer to square hectometer, km² to hm², convert square kilometer to square hectometer, square kilometer to square hectometer calculator, how many square hectometers in a square kilometer, square kilometer in square hectometer, km² to hm² converter, square kilometer to square hectometer formula, square kilometer to square hectometer chart, area conversion square kilometer to square hectometer, square kilometer to square hectometer online converter"/>
    <title>square kilometer to square hectometer Conversion (km² to hm²)</title>
        ...
        <div class="main-wrapper">
            <div class="content-section">
                <div class="converter-section">
                    <h2>square kilometer to square hectometer Converter</h2>
                    <div class="converter-tool">
                        <div class="input-group">
                            <label for="from-value">square kilometer (km²)</label>
                            <input id="from-value" oninput="performConversion('square-kilometer-km²-to-square-hectometer-hm²')" placeholder="Enter square kilometer" step="0.01" type="number" value="1"/>
                        </div>
                        <button class="swap-btn" onclick="window.location.href='square-hectometer-hm²-to-square-kilometer-km².php'" title="Convert square hectometer to square kilometer">
                    ...
                    <div class="button-group">
                        <button onclick="performConversion('square-kilometer-km²-to-square-hectometer-hm²')">Calculate</button>
                ...
                <div class="info-section">
                    <div class="about-section">
                        <h3>About square kilometer to square hectometer Conversion (km² to hm²)</h3>
                        <p>Learn how to accurately convert square kilometer (km²) to square hectometer (hm²) using verified formulas and conversion charts.</p>
                        <p><strong>Formula:</strong> 1 square kilometer = 100 square hectometer | Formula: square hectometer = square kilometer × 100</p>
