...
<head>
    ...
    <meta name="description" content="Convert square kilometer (km²) to hectare (ha) with accurate formulas, examples, and instant calculation."/>
    <meta name="keywords" content="square kilometer to hectare, km² to ha, convert square kilometer to hectare, square kilometer to hectare calculator, how many hectares in a square kilometer, square kilometer in hectare, km² to ha converter, square kilometer to hectare formula, square kilometer to hectare chart, area conversion square kilometer to hectare, square kilometer to hectare online converter"/>
    <title>square kilometer to hectare Conversion (km² to ha)</title>
        ...
        <div class="main-wrapper">
            <div class="content-section">
                <div class="converter-section">
                    <h2>square kilometer to hectare Converter</h2>
                    <div class="converter-tool">
                        <div class="input-group">
                            <label for="from-value">square kilometer (km²)</label>
                            <input id="from-value" oninput="performConversion('square-kilometer-km²-to-hectare-ha')" placeholder="Enter square kilometer" step="0.01" type="number" value="1"/>
                        </div>
                        <button class="swap-btn" onclick="window.location.href='hectare-ha-to-square-kilometer-km².php'" title="Convert hectare to square kilometer">
                    ...
                    <div class="button-group">
                        <button onclick="performConversion('square-kilometer-km²-to-hectare-ha')">Calculate</button>
                ...
                <div class="info-section">
                    <div class="about-section">
                        <h3>About square kilometer to hectare Conversion (km² to ha)</h3>
                        <p>Learn how to accurately convert square kilometer (km²) to hectare (ha) using verified formulas and conversion charts.</p>
                        <p><strong>Formula:</strong> 1 square kilometer = 100 hectare | Formula: hectare = square kilometer × 100</p>
