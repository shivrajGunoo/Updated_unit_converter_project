                ...
                <div class="converter-section">
                    ...
                    <div class="converter-tool">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" id="to-value" readonly placeholder="Result">
                    ...
                    <table class="conversion-table">
                        ...
                        <tbody id="conversion-results"></tbody>
                    </table>
                </div>

                <!-- Popular links section omitted for brevity -->
                <!-- Description and formulas section omitted for brevity -->
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            const units = {
                ...
                µm: { name: 'Micrometers', factor: 1e-6 },
                mm: { name: 'Millimeters', factor: 1e-3 },
                ...
                league: { name: 'Leagues', factor: 4828.032 },
                au: { name: 'Astronomical Units', factor: 149597870700 },
                ly: { name: 'Light Years', factor: 9.46073e15 },
                pc: { name: 'Parsecs', factor: 3.085677581e16 }
            };
