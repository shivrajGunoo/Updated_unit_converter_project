...
<head>
    ...
    <meta name="description" content="Convert Troy pound to UK Ton (lb t to long ton) easily with accurate formulas, example conversions, and SEO-friendly calculator tools."/>
    <meta name="keywords" content="troy pound to uk ton, lb t to long ton, convert troy pound to uk ton, troy pound to uk ton calculator, how many uk ton in a troy pound, troy pound in uk ton, lb t to long ton converter, troy pound to uk ton formula, troy pound to uk ton chart, weight conversion troy pound to uk ton, troy pound to uk ton online converter"/>
    <title>Troy pound to UK Ton Converter (lb t to long ton)</title>
        ...
        <div class="main-wrapper">
            <div class="content-section">
                <div class="converter-section">
                    <h2>Troy pound to UK Ton Converter (lb t to long ton)_CONTENT</h2>
                    <div class="converter-tool">
                        <div class="input-group">
                            <label for="from-value">Enter Troy pound value</label>
                            <input id="from-value" oninput="performConversion('troy-pound-lb t-to-uk-ton-long ton')" placeholder="Troy pound (lb t)" step="0.01" type="number" value="1"/>
                        </div>
                        <button class="swap-btn" onclick="window.location.href='uk-ton-long ton-to-troy-pound-lb t.php'" title="Convert UK Ton to Troy pound">
                    ...
                    <div class="button-group">
                        <button onclick="performConversion('troy-pound-lb t-to-uk-ton-long ton')">Calculate</button>
                ...
                <div class="info-section">
                    <div class="about-section">
                        <h3>Troy pound to UK Ton Converter (lb t to long ton)_ABOUT</h3>
                        <p>This page helps you convert Troy pound (lb t) to UK Ton (long ton) using accurate and verified formulas and conversion examples.</p>
<!--<p><strong>Formula:</strong> 1 long ton ≈ 270.945842 kan | Example: 0.00369037 long ton ≈ 1 kan</p>-->
                        <!--<p><strong>Example:</strong> ##EXAMPLE</p>!-->
                    </div>
                </div>

                <div class="info-section">
                    <h3>Troy pound to UK Ton Converter (lb t to long ton)_H3</h3>
                    <ul>
