...
<head>
    ...
    <meta name="description" content="Convert Troy pound to US Ton (lb t to short ton) easily with accurate formulas, example conversions, and SEO-friendly calculator tools."/>
    <meta name="keywords" content="troy pound to us ton, lb t to short ton, convert troy pound to us ton, troy pound to us ton calculator, how many us ton in a troy pound, troy pound in us ton, lb t to short ton converter, troy pound to us ton formula, troy pound to us ton chart, weight conversion troy pound to us ton, troy pound to us ton online converter"/>
    <title>Troy pound to US Ton Converter (lb t to short ton)</title>
        ...
        <div class="main-wrapper">
            <div class="content-section">
                <div class="converter-section">
                    <h2>Troy pound to US Ton Converter (lb t to short ton)_CONTENT</h2>
                    <div class="converter-tool">
                        <div class="input-group">
                            <label for="from-value">Enter Troy pound value</label>
                            <input id="from-value" oninput="performConversion('troy-pound-lb t-to-us-ton-short ton')" placeholder="Troy pound (lb t)" step="0.01" type="number" value="1"/>
                        </div>
                        <button class="swap-btn" onclick="window.location.href='us-ton-short ton-to-troy-pound-lb t.php'" title="Convert US Ton to Troy pound">
                    ...
                    <div class="button-group">
                        <button onclick="performConversion('troy-pound-lb t-to-us-ton-short ton')">Calculate</button>
                ...
                <div class="info-section">
                    <div class="about-section">
                        <h3>Troy pound to US Ton Converter (lb t to short ton)_ABOUT</h3>
                        <p>This page helps you convert Troy pound (lb t) to US Ton (short ton) using accurate and verified formulas and conversion examples.</p>
                        <p><strong>Formula:</strong> 1 long ton ≈ 1016.046909 kg | Example: 0.000984207 long ton ≈ 1 kg</p>
                        <!--<p><strong>Example:</strong> ##EXAMPLE</p>!-->
                    </div>
                </div>

                <div class="info-section">
                    <h3>Troy pound to US Ton Converter (lb t to short ton)_H3</h3>
                    <ul>
