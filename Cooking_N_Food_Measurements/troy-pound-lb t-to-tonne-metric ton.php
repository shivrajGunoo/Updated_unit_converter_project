...
<head>
    ...
    <meta name="description" content="Convert Troy pound to Tonne (lb t to metric ton) easily with accurate formulas, example conversions, and SEO-friendly calculator tools."/>
    <meta name="keywords" content="troy pound to tonne, lb t to metric ton, convert troy pound to tonne, troy pound to tonne calculator, how many tonne in a troy pound, troy pound in tonne, lb t to metric ton converter, troy pound to tonne formula, troy pound to tonne chart, weight conversion troy pound to tonne, troy pound to tonne online converter"/>
    <title>Troy pound to Tonne Converter (lb t to metric ton)</title>
        ...
        <div class="main-wrapper">
            <div class="content-section">
                <div class="converter-section">
                    <h2>Troy pound to Tonne Converter (lb t to metric ton)_CONTENT</h2>
                    <div class="converter-tool">
                        <div class="input-group">
                            <label for="from-value">Enter Troy pound value</label>
                            <input id="from-value" oninput="performConversion('troy-pound-lb t-to-tonne-metric ton')" placeholder="Troy pound (lb t)" step="0.01" type="number" value="1"/>
                        </div>
                        <button class="swap-btn" onclick="window.location.href='tonne-metric ton-to-troy-pound-lb t.php'" title="Convert Tonne to Troy pound">
                    ...
                    <div class="button-group">
                        <button onclick="performConversion('troy-pound-lb t-to-tonne-metric ton')">Calculate</button>
                ...
                <div class="info-section">
                    <div class="about-section">
                        <h3>Troy pound to Tonne Converter (lb t to metric ton)_ABOUT</h3>
                        <p>This page helps you convert Troy pound (lb t) to Tonne (metric ton) using accurate and verified formulas and conversion examples.</p>
<!--<p><strong>Formula:</strong> 1 long ton = 15680000 gr | Example: 0.0000000637755 long ton ≈ 1 gr</p>-->
                        <!--<p><strong>Example:</strong> ##EXAMPLE</p>!-->
                    </div>
                </div>

                <div class="info-section">
                    <h3>Troy pound to Tonne Converter (lb t to metric ton)_H3</h3>
                    <ul>
