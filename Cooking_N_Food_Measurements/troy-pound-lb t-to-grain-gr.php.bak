...
<head>
    ...
    <meta name="description" content="Convert Troy pound to Grain (lb t to gr) easily with accurate formulas, example conversions, and SEO-friendly calculator tools."/>
    <meta name="keywords" content="troy pound to grain, lb t to gr, convert troy pound to grain, troy pound to grain calculator, how many grain in a troy pound, troy pound in grain, lb t to gr converter, troy pound to grain formula, troy pound to grain chart, weight conversion troy pound to grain, troy pound to grain online converter"/>
    <title>Troy pound to Grain Converter (lb t to gr)</title>
        ...
        <div class="main-wrapper">
            <div class="content-section">
                <div class="converter-section">
                    <h2>Troy pound to Grain Converter (lb t to gr)_CONTENT</h2>
                    <div class="converter-tool">
                        <div class="input-group">
                            <label for="from-value">Enter Troy pound value</label>
                            <input id="from-value" oninput="performConversion('troy-pound-lb t-to-grain-gr')" placeholder="Troy pound (lb t)" step="0.01" type="number" value="1"/>
                        </div>
                        <button class="swap-btn" onclick="window.location.href='grain-gr-to-troy-pound-lb t.php'" title="Convert Grain to Troy pound">
                    ...
                    <div class="button-group">
                        <button onclick="performConversion('troy-pound-lb t-to-grain-gr')">Calculate</button>
                ...
                <div class="info-section">
                    <h3>Troy pound to Grain Converter (lb t to gr)_H3</h3>
                    <ul>
