...
<head>
    ...
    <meta name="description" content="Convert Troy pound to Dram (lb t to dr) easily with accurate formulas, example conversions, and SEO-friendly calculator tools."/>
    <meta name="keywords" content="troy pound to dram, lb t to dr, convert troy pound to dram, troy pound to dram calculator, how many dram in a troy pound, troy pound in dram, lb t to dr converter, troy pound to dram formula, troy pound to dram chart, weight conversion troy pound to dram, troy pound to dram online converter"/>
    <title>Troy pound to Dram Converter (lb t to dr)</title>
        ...
        <div class="main-wrapper">
            <div class="content-section">
                <div class="converter-section">
                    <h2>Troy pound to Dram Converter (lb t to dr)_CONTENT</h2>
                    <div class="converter-tool">
                        <div class="input-group">
                            <label for="from-value">Enter Troy pound value</label>
                            <input id="from-value" oninput="performConversion('troy-pound-lb t-to-dram-dr')" placeholder="Troy pound (lb t)" step="0.01" type="number" value="1"/>
                        </div>
                        <button class="swap-btn" onclick="window.location.href='dram-dr-to-troy-pound-lb t.php'" title="Convert Dram to Troy pound">
                    ...
                    <div class="button-group">
                        <button onclick="performConversion('troy-pound-lb t-to-dram-dr')">Calculate</button>
                ...
                <div class="info-section">
                    <h3>Troy pound to Dram Converter (lb t to dr)_H3</h3>
                    <ul>
