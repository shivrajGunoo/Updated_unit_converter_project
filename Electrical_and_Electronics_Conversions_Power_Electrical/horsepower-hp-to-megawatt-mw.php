...
<head>
    ...
    <meta name="description" content="Instantly convert Horsepower (hp) to Megawatt (MW) with accurate results. Learn the formula, example, and key FAQs for converting horsepower to megawatt."/>
    <meta name="keywords" content="horsepower to megawatt, hp to mw, convert horsepower to megawatt, horsepower to megawatt calculator, how many megawatt in a horsepower, horsepower in megawatt, hp to mw converter, horsepower to megawatt formula, horsepower to megawatt chart, power conversion horsepower to megawatt, horsepower to megawatt online converter"/>
    <title>Horsepower to Megawatt Conversion Calculator</title>
        ...
        <div class="main-wrapper">
            <div class="content-section">
                <div class="converter-section">
                    <h2>Horsepower to Megawatt Converter</h2>
                    <div class="converter-tool">
                        <div class="input-group">
                            <label for="from-value">Horsepower (hp)</label>
                            <input id="from-value" oninput="performConversion('horsepower-hp-to-megawatt-mw')" placeholder="Enter Horsepower" step="0.01" type="number" value="1"/>
                        </div>
                        <button class="swap-btn" onclick="window.location.href='megawatt-mw-to-horsepower-hp.php'" title="Swap Horsepower and Megawatt">
                    ...
                    <div class="button-group">
                        <button onclick="performConversion('horsepower-hp-to-megawatt-mw')">Calculate</button>
                ...
                <div class="info-section">
                    <div class="about-section">
                        <h3>About Horsepower to Megawatt Conversion Calculator</h3>
                        <p>Learn how to accurately convert Horsepower (hp) to Megawatt (MW) using our reliable and easy-to-use conversion tool based on official standards like NIST and BIPM.</p>
                        <p><strong>Formula:</strong> 1 Horsepower = 0.0007457 Megawatt | Formula: Megawatt = Horsepower × 0.0007457</p>
                        <!--<p><strong>Example:</strong> Convert 1 horsepower to megawatt: 1 × 0.0007457 = 0.0007457 Megawatt</p>!-->
                    </div>
                </div>
