...
<head>
    ...
    <meta name="description" content="Instantly convert Horsepower (hp) to Kilowatt (kW) with accurate results. Learn the formula, example, and key FAQs for converting horsepower to kilowatt."/>
    <meta name="keywords" content="horsepower to kilowatt, hp to kw, convert horsepower to kilowatt, horsepower to kilowatt calculator, how many kilowatt in a horsepower, horsepower in kilowatt, hp to kw converter, horsepower to kilowatt formula, horsepower to kilowatt chart, power conversion horsepower to kilowatt, horsepower to kilowatt online converter"/>
    <title>Horsepower to Kilowatt Conversion Calculator</title>
        ...
        <div class="main-wrapper">
            <div class="content-section">
                <div class="converter-section">
                    <h2>Horsepower to Kilowatt Converter</h2>
                    <div class="converter-tool">
                        <div class="input-group">
                            <label for="from-value">Horsepower (hp)</label>
                            <input id="from-value" oninput="performConversion('horsepower-hp-to-kilowatt-kw')" placeholder="Enter Horsepower" step="0.01" type="number" value="1"/>
                        </div>
                        <button class="swap-btn" onclick="window.location.href='kilowatt-kw-to-horsepower-hp.php'" title="Swap Horsepower and Kilowatt">
                    ...
                    <div class="button-group">
                        <button onclick="performConversion('horsepower-hp-to-kilowatt-kw')">Calculate</button>
                ...
                <div class="info-section">
                    <div class="about-section">
                        <h3>About Horsepower to Kilowatt Conversion Calculator</h3>
                        <p>Learn how to accurately convert Horsepower (hp) to Kilowatt (kW) using our reliable and easy-to-use conversion tool based on official standards like NIST and BIPM.</p>
                        <p><strong>Formula:</strong> 1 Horsepower = 0.7457 Kilowatt | Formula: Kilowatt = Horsepower × 0.7457</p>
                        <!--<p><strong>Example:</strong> Convert 1 horsepower to kilowatt: 1 × 0.7457 = 0.7457 Kilowatt</p>!-->
                    </div>
                </div>
