...
<head>
    ...
    <meta name="description" content="Instantly convert Watt (W) to Horsepower (hp) with accurate results. Learn the formula, example, and key FAQs for converting watt to horsepower."/>
    <meta name="keywords" content="watt to horsepower, w to hp, convert watt to horsepower, watt to horsepower calculator, how many horsepower in a watt, watt in horsepower, w to hp converter, watt to horsepower formula, watt to horsepower chart, power conversion watt to horsepower, watt to horsepower online converter"/>
    <title>Watt to Horsepower Conversion Calculator</title>
        ...
        <div class="main-wrapper">
            <div class="content-section">
                <div class="converter-section">
                    <h2>Watt to Horsepower Converter</h2>
                    <div class="converter-tool">
                        <div class="input-group">
                            <label for="from-value">Watt (W)</label>
                            <input id="from-value" oninput="performConversion('watt-w-to-horsepower-hp')" placeholder="Enter Watt" step="0.01" type="number" value="1"/>
                        </div>
                        <button class="swap-btn" onclick="window.location.href='horsepower-hp-to-watt-w.php'" title="Swap Watt and Horsepower">
                    ...
                    <div class="button-group">
                        <button onclick="performConversion('watt-w-to-horsepower-hp')">Calculate</button>
                ...
                <div class="info-section">
                    <div class="about-section">
                        <h3>About Watt to Horsepower Conversion Calculator</h3>
                        <p>Learn how to accurately convert Watt (W) to Horsepower (hp) using our reliable and easy-to-use conversion tool based on official standards like NIST and BIPM.</p>
                        <p><strong>Formula:</strong> 1 Watt = 0.00134102 Horsepower | Formula: Horsepower = Watt × 0.00134102</p>
                        <!--<p><strong>Example:</strong> Convert 1 watt to horsepower: 1 × 0.00134102 = 0.00134102 Horsepower</p>!-->
                    </div>
                </div>
