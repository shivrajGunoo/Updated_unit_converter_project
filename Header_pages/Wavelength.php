...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1" />
    <title>Wavelength Converter | nm, µm, Å, pm, mm, fm, cm – Light & Optics</title>
  <meta name="description" content="Instantly convert wavelengths across nanometer (nm), micrometer (µm), angstrom (Å), picometer (pm), millimeter (mm), femtometer (fm), and centimeter (cm). Accurate Light & Optics wavelength calculator with real‑time results and an equivalents table.">
  <meta name="keywords" content="wavelength converter, nm to um, um to nm, angstrom to nanometer, nm to angstrom, picometer to nanometer, millimeter to nanometer, centimeter to nanometer, light optics wavelength conversion, frequency wavelength optics">
      ...
      <section class="content-section">
        ...
        <div class="description-section">
          <div class="info-section">
            <h3>Popular Wavelength Conversions</h3>
            <ul>
              <li><a href="nanometer-to-micrometer.php">Nanometer (nm) to Micrometer (µm)</a></li>
<li><a href="micrometer-to-nanometer.php">Micrometer (µm) to Nanometer (nm)</a></li>
<li><a href="nanometer-to-angstrom.php">Nanometer (nm) to Angstrom (Å)</a></li>
<li><a href="angstrom-to-nanometer.php">Angstrom (Å) to Nanometer (nm)</a></li>
<li><a href="nanometer-to-millimeter.php">Nanometer (nm) to Millimeter (mm)</a></li>
<li><a href="centimeter-to-nanometer.php">Centimeter (cm) to Nanometer (nm)</a></li>
            </ul>
          </div>
        </div>
...
/* =========================
   ...
   Using meters as the hub.
   ========================= */
const conversionFactors = {
  // SI multiples (↔ m/s²)
  'meter-to-nanometer': 1000000000.0,
  'nanometer-to-meter': 1e-09,
  'meter-to-micrometer': 1000000.0,
  'micrometer-to-meter': 1e-06,
  'meter-to-angstrom': 10000000000.0,
  'angstrom-to-meter': 1e-10,
  'meter-to-picometer': 1000000000000.0,
  'picometer-to-meter': 1e-12,
  'meter-to-millimeter': 1000.0,
  'millimeter-to-meter': 0.001,
  'meter-to-femtometer': 1000000000000000.0,
